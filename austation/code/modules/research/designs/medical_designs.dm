/datum/design/custompen
	...
	materials = list(/datum/material/glass = 2000, /datum/material/plastic = 500, /datum/material/iron = 2000)
...
/datum/design/custompen/bluespace
	...
	materials = list(/datum/material/glass = 4000,  /datum/material/plastic = 1000, /datum/material/diamond = 400, /datum/material/gold = 2000, /datum/material/titanium = 1000, /datum/material/bluespace = 200)
